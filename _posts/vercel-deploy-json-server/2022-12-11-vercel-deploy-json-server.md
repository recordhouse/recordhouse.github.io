...
## 3. 회원 가입
![순서01](/assets/img/posts/vercel-deploy-json-server-img01.png)
...
![순서03](/assets/img/posts/vercel-deploy-json-server-img03.png)
 추가했던 프로젝트(저장소)를 `import` 한다.

## 5. 옵션 설정 및 배포하기
![순서04](/assets/img/posts/vercel-deploy-json-server-img04.png)
